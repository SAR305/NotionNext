...
const Footer = ({ title }) => {
  ...
  return (
    ...
    >
      ...
      <i className='fas fa-copyright' /> {`${copyrightDate}`} <div><i className='mx-1 animate-pulse fas fa-heart'/> <a href={BLOG.LINK} className='underline font-bold  dark:text-gray-300 '>{BLOG.AUTHOR}</a>.<br/>
