...
const Footer = ({ title }) => {
  ...
  return (
    ...
    >
      ...
      <h1 className='fas fa-copyright' /> {`${copyrightDate}`} <span><h1 className='mx-1 animate-pulse fas fa-heart'/> <a href={BLOG.LINK} className='underline font-bold  dark:text-gray-300 '>{BLOG.AUTHOR}</a>.<br/>
